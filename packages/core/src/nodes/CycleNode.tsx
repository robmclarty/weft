 ...
 * `<cycle>` sentinel node.
 *
 * Renders fascicle's loose-mode cycle marker as a small badge node naming the
 ...
 * the static picture and gets a dedicated visual treatment.
 */
